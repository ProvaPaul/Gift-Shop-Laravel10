...
//                 if(response.status === true) { // Assuming your response includes a status indicating success
//                     window.location.href = "{{ route('products.index') }}"; // Redirect
//                 } else {
//                     // If not successful, show errors or a specific message
//                     alert('Failed to update the product. Please check the form data.');
