...
//for stripe
Route::get('/stripe/{totalprice}',[CartController::class,'stripe'])->name('front.stripe') ;
...
// route e ? mark deya mane optional bujhay
    ...
    Route::group(['middleware'=>'admin.auth'],function(){
     ...
     //temp-image.create
        ...
        Route::delete('/brands/{brand}',[BrandController::class,'destroy'])->name('brands.delete');
         ...
         Route::post('/product/{product}',[ProductController::class,'destroy'])->name('products.delete');
